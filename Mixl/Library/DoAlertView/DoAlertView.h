...
// my color
#define DO_TITLE_BOX                DO_RGB(239, 238, 226)
#define DO_NORMAL_BOX               DO_RGB(239, 238, 226)
#define DO_BUTTON_BOX               DO_RGB(239, 238, 226)
//#define DO_BUTTON_BOX               DO_RGB(61, 155, 196)
#define DO_DESTRUCTIVE_BOX          DO_RGB(0, 0, 250)
#define DO_TEXT_COLOR               DO_RGB(41, 43, 48)
#define DO_DESTRUCTIVE_TEXT_COLOR   DO_RGB(250, 0, 0)
#define DO_DIMMED_COLOR             DO_RGBA(0, 0, 0, 0.6)


#define DO_TEXT_FONT        [UIFont fontWithName:@"GothamRounded-Book" size:14]
#define DO_BOLD_FONT        [UIFont fontWithName:@"GothamRounded-Bold" size:14]

#define DO_LABEL_INSET      UIEdgeInsetsMake(24, 20, 24, 20)
#define DO_TITLE_INSET      UIEdgeInsetsMake(10, 10, 10, 10)
