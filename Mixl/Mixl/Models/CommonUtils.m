...
- (NSString *) getFullPhotoUrl:(NSString *)url withType:(NSString *)type {
    ...
    } else if([type isEqualToString:@"bark_photo"] && [url rangeOfString:MEDIA_BARK_PHOTO_SELF_DOMAIN_PREFIX].location != NSNotFound) {
        return [MEDIA_URL_BARK_PHOTOS stringByAppendingString:[url substringFromIndex:[MEDIA_BARK_PHOTO_SELF_DOMAIN_PREFIX length]]];
    } else if([type isEqualToString:@"bark_video"] && [url rangeOfString:MEDIA_BARK_VIDEO_SELF_DOMAIN_PREFIX].location != NSNotFound) {
        return [MEDIA_URL_BARK_VIDEOS stringByAppendingString:[url substringFromIndex:[MEDIA_BARK_VIDEO_SELF_DOMAIN_PREFIX length]]];
    } else if([type isEqualToString:@"bark_video_thumb"] && [url rangeOfString:MEDIA_BARK_VIDEO_THUMB_SELF_DOMAIN_PREFIX].location != NSNotFound) {
        return [MEDIA_URL_BARK_VIDEO_THUMBS stringByAppendingString:[url substringFromIndex:[MEDIA_BARK_VIDEO_THUMB_SELF_DOMAIN_PREFIX length]]];
    } else {
        return url;
    }
}
